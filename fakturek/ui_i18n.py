...
UI_TRANSLATIONS_EN: dict[str, str] = {
    ...
    "Záznam není dostupný": "Record unavailable",
    "Záznam není dostupný – fakturek": "Record unavailable – fakturek",
    "Požadovaný záznam se nepodařilo otevřít.": "The requested record could not be opened.",
    "Jak pokračovat": "What to do next",
    "Záznam mohl být odstraněný nebo k němu nemáš přístup. Vrať se do přehledu a zkus ho vyhledat tam.": "The record may have been removed or you may not have access to it. Return to the list and try to find it there.",
    "Zavřít": "Close",
    "Zrušit": "Cancel",
    "Uložit": "Save",
    ...
    "Alespoň 12 znaků.": "At least 12 characters.",
    "Relace": "Session",
    ...
    "Nový kontakt – fakturek": "New contact – fakturek",
    "+ Nový kontakt": "+ New contact",
    "Upravit kontakt": "Edit contact",
    "Upravit kontakt – fakturek": "Edit contact – fakturek",
    "Detail kontaktu": "Contact detail",
    "Rychlé doplnění": "Quick fill",
    "Načíst kontakt podle IČO": "Look up contact by company ID",
    "CZ nebo SK IČO": "Czech or Slovak company ID",
    "Nejdřív zkus IČO v registru. Když se nic nenajde, údaje doplníš ručně.": "Start by looking up the company ID. If there is no match, enter the details manually.",
    "Údaje můžeš doplnit z registru nebo upravit ručně.": "Look up the details in a registry or edit them manually.",
    "Zpět na detail": "Back to contact",
    "E-mail(y)": "Email address(es)",
    "Více adres odděl čárkou nebo středníkem.": "Separate multiple addresses with a comma or semicolon.",
    "Pevný VS": "Fixed reference",
    "Nové faktury pro tento kontakt ho použijí automaticky.": "New invoices for this contact will use it automatically.",
    "Adresa a registr": "Address and registry",
    "Nejčastější": "Most common",
    "Všechny země": "All countries",
    "Pravidelně aktualizovat z ARES/RPO": "Keep details updated from ARES/RPO",
    "Když se změní název, adresa nebo DIČ v registru, Fakturek to převezme.": "When the name, address, or VAT ID changes in the registry, Fakturek will update it.",
    "Uložit kontakt": "Save contact",
    "Smazání kontaktu": "Delete contact",
    "Smazat kontakt": "Delete contact",
    "Neplatné IČO": "Invalid company ID",
    "Načteno z ARES.": "Loaded from ARES.",
    "Načteno z ARES (cache).": "Loaded from ARES (cache).",
    "Načteno z RPO.": "Loaded from RPO.",
    "Načteno z RPO (cache).": "Loaded from RPO (cache).",
    "Načteno z ORSR.": "Loaded from ORSR.",
    "Načteno z ORSR (cache).": "Loaded from ORSR (cache).",
...
UI_TRANSLATIONS_EN.update(
    {
        ...
        "Pro změnu hesla je potřeba zadat současné heslo. Nové heslo musí mít alespoň 12 znaků.": "To change your password, enter the current password. The new password must be at least 12 characters.",
        ...
        "Fakturek kontakty CSV v1": "Fakturek Contacts CSV v1",
        "Fakturek katalog CSV v1": "Fakturek Catalog CSV v1",
        "Bezpečný přenos kontaktů mezi Fakturky do 25 MB. Přesné shody znovu použije a existující kontakty nikdy nepřepíše.": "Safe contact transfer up to 25 MB between Fakturek installations. It reuses exact matches and never overwrites existing contacts.",
        "Fakturek native backup v1": "Fakturek native backup v1",
        "Fakturek native backup v2": "Fakturek native backup v2",
        "Fakturek native backup v3": "Fakturek native backup v3",
        "Bezpečná nativní záloha kontaktů, katalogu a bankovních účtů. Neobsahuje tokeny, synchronizaci, transakce ani faktury.": "Safe native backup of contacts, catalog items and bank accounts. It contains no tokens, synchronization state, transactions or invoices.",
        "Bezpečná nativní záloha kontaktů, katalogu, bankovních účtů a číselných řad. Neobsahuje faktury, platby, tokeny, synchronizaci ani transakce.": "Safe native backup of contacts, catalog items, bank accounts and invoice series. It contains no invoices, payments, tokens, synchronization state or transactions.",
        "Kontakty, katalog a bezpečná data účtů. Bez tokenů, synchronizace nebo transakcí.": "Contacts, catalog items and safe account data. No tokens, synchronization or transactions.",
        "Kontakty, katalog, účty a číselné řady. Bez faktur, plateb, tokenů, synchronizace nebo transakcí.": "Contacts, catalog items, accounts and invoice series. No invoices, payments, tokens, synchronization or transactions.",
        "Fakturek katalog CSV v1, native backup v1 a v2, Fakturoid, CSV kontaktů, XML/ISDOC faktury, PDF/ZIP, POHODA XML a Money S3 XML.": "Fakturek Catalog CSV v1, native backup v1 and v2, Fakturoid, contact CSV, XML/ISDOC invoices, PDF/ZIP, POHODA XML and Money S3 XML.",
        "Fakturek katalog CSV v1, native backup v1, v2 a v3, Fakturoid, CSV kontaktů, XML/ISDOC faktury, PDF/ZIP, POHODA XML a Money S3 XML.": "Fakturek Catalog CSV v1, native backup v1, v2 and v3, Fakturoid, contact CSV, XML/ISDOC invoices, PDF/ZIP, POHODA XML and Money S3 XML.",
        "Fakturek kontakty CSV v1, Fakturek katalog CSV v1, native backup v1, v2 a v3, Fakturoid, obecné CSV kontaktů, XML/ISDOC faktury, PDF/ZIP, POHODA XML a Money S3 XML.": "Fakturek Contacts CSV v1, Fakturek Catalog CSV v1, native backup v1, v2 and v3, Fakturoid, generic contact CSV, XML/ISDOC invoices, PDF/ZIP, POHODA XML and Money S3 XML.",
        ...
        "Duplicitní řádky": "Duplicate rows",
        "Osiřelá mapování k opravě": "Orphaned mappings to repair",
        "Existující kontakty se nikdy nepřepisují.": "Existing contacts are never overwritten.",
        "Přesná shoda se znovu použije. Kontakt dříve importovaný z tohoto řádku se po místní úpravě zachová beze změny a nevytvoří se jeho duplikát. Stejný název bez mapování a s jinými údaji vytvoří nový kontakt.": "An exact match is reused. A contact previously imported from this row keeps its local edits unchanged and is not duplicated. The same unmapped name with different details creates a new contact.",
        "Náhled je nezávazný: soubor i cílové kontakty se při spuštění znovu ověří. Zastaralý náhled se bezpečně odmítne bez částečného zápisu.": "The preview is non-binding: the file and destination contacts are validated again when import starts. A stale preview is safely rejected without a partial write.",
        "Prvních pět řádků": "First five rows",
        "Název": "Name",
        "Telefon": "Phone",
        "Pevný VS": "Fixed variable symbol",
        "Ověřený obsah zálohy": "Verified backup contents",
        "Kontakty nové": "New contacts",
        "Katalogové položky": "Catalog items",
        "Položky nové": "New items",
        "Bankovní účty": "Bank accounts",
        "Účty nové": "New accounts",
        "Nastaví se jako výchozí": "Will become default",
        "Číselné řady": "Invoice series",
        "Řady nové": "New series",
        "Řady znovupoužité": "Reused series",
        "Kontakty checksum": "Contacts checksum",
        "Katalog checksum": "Catalog checksum",
        "Účty checksum": "Accounts checksum",
        "Řady checksum": "Series checksum",
        "Zdrojový subjekt": "Source subject",
        "Jen informativní — importuje se do aktuálního subjektu.": "For information only — data is imported into the current subject.",
        "ověřen": "verified",
        "Účty, které už existují, se nikdy nepřepisují.": "Existing accounts are never overwritten.",
        "Výchozí účet se nastaví jen tehdy, když cílový subjekt žádný nemá.": "A default account is set only when the destination subject has none.",
        "Nové účty zachovají vzájemné pořadí zálohy a zařadí se za cílové účty.": "New accounts preserve their relative backup order and are placed after destination accounts.",
        ...
        "Číselné řady se při shodném názvu jen znovu použijí a nikdy se nepřepisují.": "Invoice series with a matching name are only reused and never overwritten.",
        "Nové řady se vytvoří přesně s bezpečným stavem ze zálohy.": "New series are created exactly with the safe state from the backup.",
        "Faktury, platby, opakované faktury, profil, nastavení, tajné klíče, synchronizace ani transakce nejsou součástí zálohy.": "Invoices, payments, recurring invoices, profile data, settings, secrets, synchronization state and transactions are not part of the backup.",
        "Nové řady se vytvoří přesně s bezpečným stavem ze zálohy. Faktury, platby, opakované faktury, profil, nastavení, tajné klíče, synchronizace ani transakce nejsou součástí zálohy.": "New series are created exactly with the safe state from the backup. Invoices, payments, recurring invoices, profile data, settings, secrets, synchronization state and transactions are not part of the backup.",
        "Náhled je aktuální, ale nezávazný: soubor, cílové účty i číselné řady se znovu ověří při spuštění importu.": "The preview is current but non-binding: the file, destination accounts and invoice series are validated again when import starts.",
        "Řada": "Series",
        "Akce": "Action",
        "Další číslo": "Next number",
        "nová": "new",
        "znovupoužije se": "reused",
        (
        ...
        "ZIP byl plně ověřen. Importuje pouze kontakty, katalog, bezpečná pole účtů a číselné řady; nikdy faktury, platby, tokeny, synchronizaci ani transakce.": "The ZIP was fully validated. It imports only contacts, catalog items, safe bank-account fields and invoice series, never invoices, payments, tokens, synchronization state or transactions.",
        ...
        "Fakturoid export": "Fakturoid export",
        "POHODA XML": "POHODA XML",
        "Money S3 XML": "Money S3 XML",
        "ISDOC": "ISDOC",
        "PDF / ZIP archiv": "PDF / ZIP archive",
        "Nahráno": "Uploaded",
        "Probíhá": "In progress",
        "Dokončeno": "Completed",
